...
sub read_loader {
    my ($name) = @_;
    # $name = find_file ("/home/dustin/Desktop/PINTOS-Ubuntu/src/userprog/build/loader.bin") if !defined $name;
    $name = find_file ("/home/dustin/Desktop/PINTOS-Ubuntu/src/vm/build/loader.bin") if !defined $name;
